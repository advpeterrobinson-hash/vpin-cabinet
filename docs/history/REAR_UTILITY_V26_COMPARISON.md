> HISTORICAL COMPARISON: owner selected A. Underside B is rejected and absent from active generation. Status statements below describe the pre-selection study.
