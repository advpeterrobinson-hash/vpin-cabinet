...
UCFL202 mounting holes, prop receiver mounts and latch hardware
...
def main(doc=None) -> None:
    ...
    # Captive prop rods are generated by build_owner_services_v27 from these datums.
    ...
    group.SafetyStatus = "DUAL CAPTIVE PINNED PROP RODS + TWO POSITIVE CLOSED LATCHES REQUIRED"
    ...
    print("Lift                       MANUAL / two captive positive prop rods")
