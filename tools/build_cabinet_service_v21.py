...
def main() -> None:
    ...
    group.Label = "CABINET SERVICE v0.21 - CLASSIC LEGS / PINSKATES / LIFT-OUT PC"
    ...
    group.PCServicePolicy = "LIFT-OUT FROM ABOVE; NO FORWARD/FRONT DRAWER TRAVEL; QUICK-DISCONNECT HARNESS REQUIRED"
