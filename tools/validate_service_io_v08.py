...
def main():
    ...
    assert c['selected_architecture']=='A' and 'B' not in c
    ...
    print('PASS utility policy: mains + optional Ethernet only; selected rear face; independent enclosure; CPU datum unchanged')
    return 0
